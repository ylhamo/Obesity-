...
The analysis supports the hypothesis that lower-income groups have higher obesity rates than higher-income groups across U.S. states. The lowest income group (**less than $15,000**) had the highest average obesity rate at **35.84%**, while the highest income group (**$75,000 or greater**) had the lowest average obesity rate at **29.02%**. These findings suggest an inverse relationship between income level and obesity rates, where obesity tends to decrease as income increases.
